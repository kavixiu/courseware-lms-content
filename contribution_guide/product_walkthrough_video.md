...
3 | Video Overview | Provide a video overview. | 2-4 sentences (narration) AND 2-4 bullet points (visual) |  *"In this video I will (overall video intention). First, I will (agenda item 1), then I will (agenda item 2). Next I will (agenda item 3). Lastly I will (agenda item 4)."* **Bullet points: Item 1, Item 2, Item 3, Item 4**
