...
1. Title card (3 seconds)  
  * Visual: Title card (insert screenshot)![Screenshot of title card](/example_screenshots/example-title-card.png "Optional Title")  
...
3. Video Overview (30 seconds)  
  * Visual: Table of contents slide (insert screenshot)
...
4. Training content (5-8 minutes)
  * Visual: Screencast (may be command-line, enterprise tool, website, or another visual) screenshot
...
5. Video recap and resources (30 seconds)
  * Visual: Table of contents (insert screenshot)
...
6. Outro animation (4 seconds) - add screenshot
