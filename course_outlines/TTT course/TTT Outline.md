...
As a new instructor, I need to understand course outcomes and Puppet best practices so that I can independently run my classes with confidence
...
* Working with groups and how to encourage interaction
* Addressing classroom challenges: disruptions, surprises, not knowing
* Understanding intercultural communication and norms
* Speaking about Puppet and its products with authority and confidence

**Outcomes**
* Decrease onboarding time for new instructors
* Increase NPS scores for training
* Decrease escalation and support needs for instructor-led trainings

**Methods**
* Create Puppet best practices for teaching & learning experience that focuses on quality
* Provide instructors with support, resources, and training they need to succeed
